...
export default class ColorTheme extends Component {
  ...
  updateColors = (theme) => {
    const { badTheme, goodTheme, okayTheme } = this.state;
    let newTheme;
    switch (theme) {
      case 'bad':
        newTheme = badTheme;
            ...
            <div className="inner">
              ...
              <section id="banner">
                ...
                <span className="image object">
                  <img src="images/pic12.jpg" alt="test image" />
                </span>
              </section>
              ...
              <section>
                ...
                <div className="posts">
                  <article>
                    <a className="image"><img src="images/pic01.jpg" alt="test image" /></a>
                  ...
                  <article>
                    <a className="image"><img src="images/pic02.jpg" alt="test image" /></a>
                  ...
                  <article>
                    <a className="image"><img src="images/pic03.jpg" alt="test image" /></a>
                  ...
                  <article>
                    <a className="image"><img src="images/pic04.jpg" alt="test image" /></a>
                  ...
                  <article>
                    <a className="image"><img src="images/pic05.jpg" alt="test image" /></a>
                  ...
                  <article>
                    <a className="image"><img src="images/pic06.jpg" alt="test image" /></a>
            ...
            <div className="inner">
              ...
              <section>
                ...
                <div className="mini-posts">
                  <article>
                    <a className="image"><img src="images/pic07.jpg" alt="test image" /></a>
                    <p>Aenean ornare velit lacus, ac varius enim lorem ullamcorper dolore aliquam.</p>
                  </article>
                  <article>
                    <a className="image"><img src="images/pic08.jpg" alt="test image" /></a>
                    <p>Aenean ornare velit lacus, ac varius enim lorem ullamcorper dolore aliquam.</p>
                  </article>
                  <article>
                    <a className="image"><img src="images/pic09.jpg" alt="test image" /></a>
                    <p>Aenean ornare velit lacus, ac varius enim lorem ullamcorper dolore aliquam.</p>
                  </article>
                </div>
                <ul className="actions">
